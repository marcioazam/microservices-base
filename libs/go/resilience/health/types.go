// Package health provides health aggregation and monitoring types.
package health
...
const (
	// HealthHealthy indicates the service is healthy.
	HealthHealthy HealthStatus = "healthy"
	// HealthDegraded indicates the service is degraded but functional.
	HealthDegraded HealthStatus = "degraded"
	// HealthUnhealthy indicates the service is unhealthy.
