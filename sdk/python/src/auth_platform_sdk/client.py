"""Auth Platform SDK clients - December 2025 State of Art.

Provides sync and async clients with DPoP, PKCE, JWKS caching,
...
if TYPE_CHECKING:
    from .models import AuthorizationRequest, PKCEChallenge


class AuthPlatformClient:
    """Synchronous Auth Platform client with full OAuth 2.0 support."""
    ...
    def client_credentials(self, *, scopes: list[str] | None = None) -> TokenResponse:
    ...
    def refresh_token(self, refresh_token: str | None = None) -> TokenResponse:
    ...
    def _token_request(self, data: dict[str, Any]) -> TokenResponse:
        ...
        if response.status_code == 400:
            ...
            if error_data.get("error") == "use_dpop_nonce":
                ...
                return self._token_request(data)  # Retry with nonce
